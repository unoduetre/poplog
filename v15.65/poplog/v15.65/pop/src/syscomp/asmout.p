...
/* --- Revision History ---------------------------------------------------
--- Aaron Sloman, May 15 2012
	Changed last change from -m32-bit to m32 (thanks to help from Peter Lewis)
--- Aaron Sloman, May  4 2012
	Altered cc_link_command_header to include -m32-bit to allow compilation
	on 64 bit linux.
--- Aaron Sloman, Feb 19 2012
	Altered cc_link_command_header include --no-as-needed
	(to override new Ubuntu default, which stopped libXm and libXext being linked)
